...
void main() async {
				...
				"/fakePath": builder.mock(
					...
					get: [
						...
						builder.doModifier((modifier, handler) {
							handler.success(dataBody: "get www.baidu.com/fakePath mocked! params: ${modifier.getResolverUrl().queryParams}");
						}),
					],
					// 拦截全部 POST 请求
					post: [
	...
	// 可以参考下方实现
	final builder1 = (MockClientBuilder builder) => <String, dynamic> {
		"www.baidu.com": {
	...
	final builder2 = (MockClientBuilder builder) => <String, dynamic> {
		"www.baidu.com": {
