...
class PassHttpUtils {
  ...
  static PassResolveUrl resolveUrl(String url) {
    try {
      ...
      return PassResolveUrl(url: url, protocol: resultList[0], host: hostStr, domain: domainStr, port: portStr != null ? int.tryParse(portStr) : null, path: resultList[4], queryParams: resultList[5]);
    } catch (e) {
      return null;
    }
  }
